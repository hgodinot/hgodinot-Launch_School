...
test("range puts the arguments in order", function() {
  return _.range(10, 0)[9] === 9;
});
...
test("lastIndexOf returns -1 when no matching value", function() {
  return _([3, 4, 6]).lastIndexOf(5) === -1;
});
