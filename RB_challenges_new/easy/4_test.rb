...
class TestAnagram < Minitest::Test
  ...
  def test_invalid_argument_array
    assert_raises ArgumentError do
      Anagram.new(["Anagram"])
    end
  end
  ...
  class AnagramTest < Minitest::Test
    ...
    def test_anagrams_are_case_insensitive_and_have_no_duplicates
      detector = Anagram.new('Orchestra')
      anagrams = detector.match %w(cashregister carthorse Cathorse radishes)
      assert_equal ['carthorse'], anagrams
    end
  end
end